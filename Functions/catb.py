...
print("subset")
X_train, X_test, y_train, y_test = train_test_split(principalComponents_more[:,:230], y2, test_size=0.33, random_state=42, stratify=y)
model_CBC = ctb.CatBoostClassifier()
model_CBC.fit(X_train, y_train)
# print(model_CBC)
predicted_y = model_CBC.predict(X_test)
...
print("all symptoms")
X_train, X_test, y_train, y_test = train_test_split(principalComponents_more_all[:,:230], y2, test_size=0.33, random_state=42, stratify=y)
